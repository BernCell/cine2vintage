...
const VintageForm = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://api.themoviedb.org/3/search/movie?query=${debouncedSearchQuery}&api_key=eee5052f80218fbb33d3368694940bf1&language=fr-FR`).then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`/https://api.themoviedb.org/3/discover/movie?primary_release_date.gte=${startDate}&primary_release_date.lte=${endDate}&with_original_language=${language}&api_key=eee5052f80218fbb33d3368694940bf1&language=fr-FR`)
            .then(response => {
